...
Если средняя оценка студента равна 5, то сумма 100$, иначе 80$. Переопределить этот метод в классе Aspirant.
...
*/
  ...
  let students = [];
let student = new Student("Полина", "Рапеева", 107, 7.5 );
students.push(student);
let aspirant = new Aspirant("Сергей", "Небылицин", 116, 9.2, "Что-то написано");
