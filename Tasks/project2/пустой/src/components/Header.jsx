...
//const { FaShoppingBasket } = require("react-icons/fa");
...
//                    <FaShoppingBasket className={`shop-basket-button`} onClick={() => { props.push("/basket") }} />
//                            <li onClick={() => { props.push("/basket") }}> Корзина</li>
